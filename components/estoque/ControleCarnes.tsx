...
export const ControleCarnes: React.FC<ControleCarnesProps> = ({ user }) => {
    ...
    return (
        <div className="max-w-6xl mx-auto animate-fadeIn pb-32">
             <div className="bg-white rounded-[2.5rem] shadow-card border border-slate-100 mb-8 overflow-hidden">
                
                {/* Header & Controls */}
                <div className="p-8 bg-white border-b border-slate-50 flex flex-col gap-6 sticky top-16 z-30 shadow-sm">
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                        <div>
                            <h2 className="text-2xl font-black text-slate-800 flex items-center gap-3 uppercase tracking-tight">
                                <Beef size={32} className="text-heroRed"/> Controle Diário
                            </h2>
